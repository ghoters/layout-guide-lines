        ...
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-2">
          <div>
            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-5 md:gap-4">
                {steps.map((s) => (
                  <div key={s.n} className="flex h-full flex-col items-center gap-3 text-center">
