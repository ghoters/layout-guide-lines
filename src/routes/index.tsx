      ...
      <section className="relative">
        <div className="relative w-full overflow-hidden">
          ...
          <div className="relative mx-auto min-h-[620px] max-w-[1200px] px-6 pb-20 pt-20 lg:min-h-[620px]">
            <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[1fr_auto] lg:pt-8">
              ...
              <a
                href="#realizacje"
                className="group hidden w-[220px] rounded-2xl border border-border bg-background/80 p-5 shadow-lg backdrop-blur-sm transition hover:shadow-xl lg:block"
              >
                <div className="text-xs font-semibold tracking-wide text-[var(--brand)]">Ostatni projekt</div>
                <div className="mt-2 text-base font-bold">wazon gotycki</div>
                <div className="mt-1 text-xs text-muted-foreground">Druk 3D, żywica</div>
                <div className="mt-4 flex items-center justify-between text-xs text-muted-foreground">
                  <span>Blender, ZBrush, Marmoset Toolbag</span>
                  <ArrowRight className="h-4 w-4 shrink-0 text-[var(--brand)] transition group-hover:translate-x-0.5" />
                </div>
              </a>
            </div>
          </div>
